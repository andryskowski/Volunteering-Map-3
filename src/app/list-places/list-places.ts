...
@Component({
  ...
  imports: [DatePipe, CommonModule, HttpClientModule, ReactiveFormsModule],
})
export class ListPlaces implements OnInit {
  ...
  ngOnInit(): void {
    this.http.get<Place[]>('assets/data/places.json').subscribe((data) => {
      ...
      // dopiero teraz filtrujemy
      this.applyFilters();

      // ustaw subskrypcję valueChanges po wczytaniu danych
